...
export default function AddFeedbackPage() {
  ...
  }, [chooseFeedback, chooseStaff, token, params.month,]);
  ...
  return (
    <main>
      ...
      >
        <div className="flex max-lg:block max-lg:justify-center justify-between relative">
        ...
        <div className="flex mt-5 gap-5">
          ...
          <div className="flex flex-col max-lg:hidden flex-1 gap-3 max-h-[600px] relative overflow-auto rm-scroll">
